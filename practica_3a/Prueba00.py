...
class Prueba00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "not titled yed", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("not titled yed")
        ...
        self.t_band = t_band = samp_rate/300
        self.ka = ka = 1
        self.fm = fm = 1000
        ...
        self._fm_range = qtgui.Range(300, samp_rate/4, 1e2, 1000, 200)
        ...
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "ganancia de la transmision", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = qtgui.Range(0, 1, 1e-2, 500e-3, 200)
        ...
        self._Ac_range = qtgui.Range(0, 500e-3, 1e-2, 500e-3, 200)
        ...
        self._t_band_range = qtgui.Range(0, samp_rate/20, 100, samp_rate/300, 200)
        ...
        self.qtgui_time_sink_x_0.set_block_alias("time")
        ...
        self.qtgui_freq_sink_x_0.set_block_alias("com")
        self._fcut_range = qtgui.Range(0, samp_rate/2, 100, samp_rate/2, 200)
        self._fcut_win = qtgui.RangeWidget(self._fcut_range, self.set_fcut, "FRECUENCIA corte filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcut_win)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_float*1)
        self.blocks_null_source_0.set_block_alias("blocks_null_source_0")
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(Ac)
        self.blocks_multiply_const_vxx_1.set_block_alias("blocks_multiply_const_vxx_1")
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(ka)
        self.blocks_multiply_const_vxx_0.set_block_alias("blocks_multiply_const_vxx_0")
        self.blocks_float_to_complex_0_0 = blocks.float_to_complex(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(1)
        self.blocks_add_const_vxx_0.set_block_alias("blovks_add_const_vxx_0")
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fm, Am, 0, 0)
        self._No_range = qtgui.Range(0, 100e-3, 1e-6, 1e-4, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_t_band(self.samp_rate/300)
